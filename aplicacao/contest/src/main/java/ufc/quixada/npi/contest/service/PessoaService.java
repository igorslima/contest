...
public class PessoaService {
	...
	public List<Pessoa> getAutoresEvento(Long idEvento){
		return pessoaRepository.findPessoaByParticipacoesEventoEventoIdAndParticipacoesEventoPapel(idEvento, Tipo.AUTOR);
	}
